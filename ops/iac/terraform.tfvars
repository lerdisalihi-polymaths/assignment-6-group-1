    ...
    "widgets": [
        {
            ...
            "properties": {
                "metrics": [
                    ["AWS/ECS", "CPUUtilization", "ServiceName", "task-api-dev", "ClusterName", "task-api-dev"],
                    [".", "MemoryUtilization", ".", ".", ".", "."]
                ],
                "view": "timeSeries",
                "stacked": false,
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    ["AWS/ApplicationELB", "TargetResponseTime", "LoadBalancer", "app/task-api-dev/1aff461ee94a079c"],
                    [".", "RequestCount", ".", "."],
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    ["AWS/RDS", "CPUUtilization", "DBInstanceIdentifier", "task-api-dev-db"],
                    [".", "DatabaseConnections", ".", "."],
                    [".", "FreeStorageSpace", ".", "."]
                ],
                "view": "timeSeries",
        ...
        },
        {
            ...
            "properties": {
                "metrics": [
                    ["AWS/ECS", "RunningTaskCount", "ServiceName", "task-api-dev", "ClusterName", "task-api-dev"],
                    [".", "PendingTaskCount", ".", ".", ".", "."]
                ],
                "view": "timeSeries",
                "stacked": false,
